...
//	}
//	err := pluginsdk.SetColumns(asset, []oracleColumn{ ... })
//
// A source whose fields do not match Column at all (a string is_nullable, or no
// nullability) can pass a fully custom slice; SetColumns only marshals it.
